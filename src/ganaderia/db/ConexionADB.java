 ...
 *
 * Wallet: cwallet.sso / ewallet.p12 / truststore.jks / keystore.jks Host:
 * adb.us-ashburn-1.oraclecloud.com Puerto: 1522 (TLS)
 */
public class ConexionADB {
    ...
    /**
     * Retorna la conexion activa (Singleton). La crea si no existe o si fue
     * cerrada.
     */
    ...
    /**
     * Alternativa con JKS (si cwallet.sso falla). Descomenta este metodo y
     * comenta crearConexion() si es necesario.
     */
